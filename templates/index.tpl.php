...
<form method="post" accept-charset="UTF-8" class="form-horizontal" id="frontpage-statement" style="display:none">
	...
	<div class="form-group">
		<div class="col-md-6">
			...
			<textarea class="form-control" rows="3" id="statement" name="statement" placeholder="Please enter your statement." required maxlength="4096"><?php print(htmlentities($statement)); ?></textarea>
		</div>
	</div>
